...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[color:var(--background)] flex flex-col font-sans marketing-page-bg">
        ...
        <ScrollReveal className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7 text-left space-y-6">
            <h1 className="text-4xl sm:text-6xl font-extrabold text-[color:var(--foreground)] leading-tight tracking-tight">
              HR That{" "}
              <span style={{ color: "var(--primary)" }}>Actually Works</span>
            </h1>
      ...
      <section
        id="features"
        className="py-20 border-t border-b border-[color:var(--border)] px-4"
        style={{ background: "var(--muted)" }}
      >
        <ScrollReveal className="max-w-7xl mx-auto space-y-12">
          <div className="text-center space-y-2">
            ...
            <p className="text-[color:var(--muted-foreground)] max-w-md mx-auto">
              Eliminate disjointed tools. Run your company operations under a
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((f) => (
              <div key={f.title} className="pc-card p-6 space-y-3">
                ...
                <h3 className="font-semibold text-base text-[color:var(--foreground)]">
                  {f.title}
                </h3>
      ...
      <section className="py-20 px-4 bg-[color:var(--muted)]/50 border-b border-[color:var(--border)]">
        <ScrollReveal className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-3 pt-2">
              {[
                ...
                <div key={idx} className="flex items-center gap-2">
                  <Check
                    size={16}
                    className="text-[color:var(--success)] flex-shrink-0"
                  />
        ...
        <ScrollReveal className="max-w-7xl mx-auto space-y-12">
          <div className="text-center space-y-2">
            <h2 className="text-3xl font-bold">
              Predictive, Transparent Pricing
            </h2>
            <p className="text-[color:var(--muted-foreground)] max-w-md mx-auto">
      ...
      <section
        id="customers"
        className="py-20 border-t border-[color:var(--border)] px-4"
        ...
        <ScrollReveal className="max-w-7xl mx-auto space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              {
                quote:
                  "The D3 org chart is stunning. It helps new hires visual their reporting lines and team members instantly.",
                author: "Marcus Chen",
              ...
              <div
                key={idx}
                className="pc-card p-6 flex flex-col justify-between"
              >
